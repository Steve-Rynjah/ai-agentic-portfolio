...
export default function Home() {
  ...
  return (
    <div className="h-full relative bg-white overflow-hidden">
      {/* ── Water ripple canvas (z-5, behind everything) */}
      <MouseGlow />

      {/* ── Dynamic background watermark text */}
      <div className="absolute bottom-0 left-0 right-0 pointer-events-none select-none flex justify-center overflow-hidden" style={{ zIndex: 1 }}>
      ...
      {/* ── Floating glass bottom tabs (z-40) */}
      <div
